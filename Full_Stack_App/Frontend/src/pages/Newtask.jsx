  ...
  export default function Newtask() {
    ...
    const [status,setStatus]=useState("")
      ...
      const handleaddnewtask=()=>{
        const payload={
            assignee,task_type,description,status
        }
        console.log(payload)
                  ...
                  <VStack spacing={5}>
                    <FormControl isRequired>
                      <InputGroup>
                        ...
                        <Input type="text" value={assignee} onChange={(e)=>setAssignee(e.target.value)} placeholder="Your Name" />
                      </InputGroup>
                    </FormControl>
  
                    <Select  value={task_type} onChange={(e)=>setTask_type(e.target.value)}
          id="task"
          name="task"
          autoComplete="task"
